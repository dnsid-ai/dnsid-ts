---
title: "TypeScript: @identity-digital/dnsid-log-c2sp-tlog — interfaces"
description: "Interfaces exported by @identity-digital/dnsid-log-c2sp-tlog."
---

<!-- Generated by `npm run docs:md` from TSDoc comments. Do not edit by hand; see docs/AGENTS.md. -->

Part of [Transparency log](https://docs.dnsid.ai/reference/ts/dnsid-log-c2sp-tlog/) (`@identity-digital/dnsid-log-c2sp-tlog`).
